...
Vault autogenerada por `scripts/actualizar_vault.py` en cada commit — 58 planes, 65 specs. Las notas espejo no se editan aquí; la fuente de verdad sigue siendo `docs/` y la raíz del repo.
