...
Vault autogenerada por `scripts/actualizar_vault.py` en cada commit — 50 planes, 57 specs. Las notas espejo no se editan aquí; la fuente de verdad sigue siendo `docs/` y la raíz del repo.
