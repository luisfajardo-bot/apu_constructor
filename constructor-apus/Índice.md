...
Vault autogenerada por `scripts/actualizar_vault.py` en cada commit — 53 planes, 59 specs. Las notas espejo no se editan aquí; la fuente de verdad sigue siendo `docs/` y la raíz del repo.
